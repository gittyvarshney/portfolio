            ...
            <ul className='menu-list'>
                {menu_links.map((n,i) => { 
                    if(n !== 'Resume'){
                        ...
                        return (<li key={`menu-items-${i+1}`}><a href={`https://drive.google.com/file/d/1ko8ND2SS9UiCxt33zuj_s6zFhwAMkFZy/view?usp=sharing`} target="_blank" rel="noreferrer noopener" >{n}</a></li>)
                    }
                        })}
            </ul>
        </Modal>
